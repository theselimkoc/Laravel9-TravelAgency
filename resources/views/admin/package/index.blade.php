    ...
    <div id="content">
        ...
        <div class="inner" style="min-height:1200px;">
            ...
            <div>
                <div class="row">
                    <div class="col-lg-2">
                        <a href="{{route('admin.package.create')}}" class="btn btn-block btn-default btn-sm"
                           style="width: 200px"> Add Package</a>
                                        ...
                                        <td>
                                            <a href="{{route('admin.image.index',['pid'=>$rs->id])}}"
                                               onclick="return !window.open(this.href,'','top=50 left=100 width=1100,height=700')">
                                                <img src="{{asset('assets')}}/admin/img/gallery.jpg"
                                                     style="height: 40px">
                                            </a>
                                        </td>
                                        <td>{{$rs->status}}</td>
                                        <td><a href="{{route('admin.package.edit',['id'=>$rs->id])}}"
                                               class="btn btn-primary"><i class="icon-pencil icon-white"></i> Edit</a>
                                        </td>
                                        <td><a href="{{route('admin.package.destroy',['id'=>$rs->id])}}"
                                               class="btn btn-danger"
                                               onclick="return confirm('Deleting !! Are you sure ?')"><i
                                                    class="icon-remove icon-white"></i> Delete</a></td>
                                        <td><a href="{{route('admin.package.show',['id'=>$rs->id])}}"
